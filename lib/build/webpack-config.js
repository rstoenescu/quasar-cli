  ...
  if (cfg.ctx.dev) {
    ...
    webpackConfig.plugins.push(
      ...
      new FriendlyErrorsPlugin({
        compilationSuccessInfo: ['spa', 'pwa', 'test'].includes(cfg.ctx.modeName) ? {
          messages: [
...
// test specific setups
  if (cfg.ctx.mode.test) {
    // need to move mocha-webpack.opts to the root folder next to packace.json
