...
class Mode {
  ...
  add (params) {
    ...
    log(`Please add the following to your "scripts": { "test": 
    "cross-env NODE_ENV=test nyc mocha-webpack --webpack-config test/webpack.test.js --require test/setup.js test/**/*.spec.js"
    `)
    log(`Now run "yarn test && quasar test" to see integration testing.`)
  }
